...
class RolesAPIController extends AppBaseController
{
    ...
    public function store(CreateRolesAPIRequest $request)
    {
        ...
        return $this->sendResponse(new RolesResource($roles), 'Roles saved successfully');
    }
    ...
    public function show($id)
    {
        ...
        return $this->sendResponse(new RolesResource($roles), 'Roles retrieved successfully');
    }
